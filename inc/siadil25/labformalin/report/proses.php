...
if ($request == 'ambildatatahun') {
    ...
    $query = sqlsrv_query($koneksi, "SELECT DISTINCT year(tgl_kegiatan) as tahun FROM View_rek_uv_ruangan ORDER BY tahun DESC");
...
if ($request == 'ambildatabulan') {
    ...
    $query = sqlsrv_query($koneksi, "SELECT DISTINCT month(tgl_kegiatan) as bulan FROM View_rek_uv_ruangan ORDER BY bulan ASC");
