                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" v-model="currentData.tgl_uji" disabled>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="mb-3">
                                        <label for="analis" class="form-label">Analis</label>
                                        <auto-suggest v-model="currentData.nama_pegawai" :suggestions="Analis" display-key="nama_pegawai" extra-key="nip_pegawai" @input="debouncedSearchAnalis" @select="selectAnalis"></auto-suggest>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
