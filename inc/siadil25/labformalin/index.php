                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><a href="../labformalin/penerimaan/" class="card-link">Penerimaan Sample</a></li>
                                <li><a href="../labformalin/hasil/" class="card-link">Hasil Pengujian</a></li>
                                <li><a href="../labformalin/bahan/" class="card-link">Permintaan Bahan</a></li>
                                <li><a href="../labformalin/rekaman_rh_temperatur/" class="card-link">Rekaman Ruang Pengujian</a></li>
                                <li><a href="../labformalin/rekaman_uv_ruang/" class="card-link">Rekaman UV Ruang Pengujian</a></li>
                                <li><a href="../labformalin/rekaman_uv_alat/" class="card-link">Rekaman UV Alat Pengujian</a></li>
                                <li><a href="../labformalin/report/" class="card-link">Laporan</a></li>
                                <li><a href="../labformalin/users/" class="card-link">User</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
