...
<page backtop="40mm" backbottom="20mm" backleft="15mm" backright="10mm">
	<page_header>
		<div class="conthead">
	...
	<?php
	$pilih = $_REQUEST['idx'];
	$sql = "SELECT * FROM  v_permintaan_bahan WHERE idx='$pilih'";
	$data = sqlsrv_query($dbconnect, $sql);
	...
	<table border="1">
		...
		?>
			...
			<tr>
				<td width="70" align="center"><?php echo date_format($r['tanggal'], 'd-m-Y'); ?></td>
				...
				<td width="150" align="center"><?php echo $r['nama_pemohon']; ?></td>
			</tr>
		<?php } ?>
	</table>
	<br>
	...
	<?php
	$idx = $_REQUEST['idx'];
	$sql = "SELECT DISTINCT TOP 1 nama_pemohon,nip_nama_pemohon,petugas_bahan,nip_petugas_bahan,idx FROM  v_permintaan_bahan WHERE idx='$idx'";
	$data1 = sqlsrv_query($dbconnect, $sql);
			...
			<tr>
				<td width="250">
					<div class="container">
						...
						echo '<br>';
						echo '<br>';
						echo '<div class="subjudul">' . $r1['petugas_bahan'] . '</div>';
						echo "NIP. " . $r1['nip_petugas_bahan'];
						?>
					</div>
				</td>
				<td width="30"></td>
				<td width="250">
					<div class="container">
						...
						echo "Penyelia/Analis," . '<br>';
						echo '<br>';
						echo '<br>';
						echo '<br>';
						echo '<br>';
						echo '<div class="subjudul">' . $r1['nama_pemohon'] . '</div>';
						echo "NIP. " . $r1['nip_nama_pemohon'];
						?>
					</div>
				</td>
			</tr>
