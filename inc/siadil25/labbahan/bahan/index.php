                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        ...
                                        <auto-suggest v-model="newData.nama_pegawai" :suggestions="petugasBahan" display-key="nama_pegawai" extra-key="nip_pegawai" @input="debouncedSearchPetugasBahan" @select="selectPetugasBahan"></auto-suggest>
                                    </div>
                                </div>
