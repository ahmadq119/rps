    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav justify-content-center">
                <li class="nav-item">
                    <a class="nav-link <?= $current_page == '../labbahan/index' ? 'active' : '' ?>" aria-current="page" href="../index.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current_page == 'permintaan/index' ? 'active' : '' ?>" href="../permintaan/"><i class="fas fa-flask"></i> Permintaan Bahan</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current_page == 'dataprint/index' ? 'active' : '' ?>" href="../dataprint/"><i class="fas fa-print"></i> Cetak Permintaan Bahan</a>
                </li>
                <li class="nav-item">
