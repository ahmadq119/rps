        ...
        <div class="row justify-content-center">
            <div class="col-6">
                ...
                <div class="row justify-content-center mb-4">
                    <div class="col-6">
                        <input type="text" class="form-control" v-model="searchQuery" placeholder="Cari berdasarkan Nama User">
                    </div>
                    <div class="col-auto">
                ...
                <table class="table table-bordered table-striped table-sm" v-if="info.length > 0">
                    ...
                    <tbody>
                        <tr v-for="(a, index) in info" :key="a.id_user">
                            <td>{{ index + 1 }}</td>
                            <td>{{ a.nama }}</td>
                            <td>{{ a.username }} </td>
                            <td>{{ a.password }} </td>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <select v-model="currentData.ruangid" class="form-control form-control-sm">
                                            <option v-for="nr in namaRuang" :value="nr.ruangid">{{ nr.nama_ruang }}</option>
                                        </select>
                                    </div>
                                </div>
