        ...
        <div class="row justify-content-center">
            <div class="col-6">
                ...
                <div class="row justify-content-center mb-4">
                    <div class="col-6">
                        <input type="text" class="form-control" v-model="searchQuery" placeholder="Cari berdasarkan Kondisi Sample">
                    </div>
                    <div class="col-auto">
                ...
                <table class="table table-bordered table-striped table-sm" v-if="info.length > 0">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Organ Target</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="(a, index) in info" :key="a.idkondisi">
                            <td>{{ index + 1 }}</td>
                            <td>{{ a.nama_organ }}</td>
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="tambahData">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label">Nama Organ Target</label>
                                        <input type="text" class="form-control form-control-sm" v-model="newData.nama_organ" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" v-model="currentData.nama_organ" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
