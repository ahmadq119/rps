                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" v-model="newData.kondisi_sample" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <form @submit.prevent="updateData">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label">Kondisi Sample</label>
                                        <input type="text" class="form-control form-control-sm" v-model="currentData.kondisi_sample" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
