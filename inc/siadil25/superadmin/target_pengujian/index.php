        ...
        <div class="row justify-content-center">
            <div class="col-6">
                ...
                <div class="row justify-content-center mb-4">
                    <div class="col-6">
                        <input type="text" class="form-control" v-model="searchQuery" placeholder="Cari berdasarkan Target Pengujian">
                    </div>
                    <div class="col-auto">
                ...
                <table class="table table-bordered table-striped table-sm" v-if="info.length > 0">
                    <thead>
                        <tr>
                            ...
                            <th>Metode Pengujian (Acuan Standar)</th>
                            <th>Rencana Ruang Distibusi (ID Ruang)</th>
                            <th>Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr v-for="(a, index) in info" :key="a.idtarget">
                            <td>{{ index + 1 }}</td>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-sm" v-model="newData.target_pengujian" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label">Metode Pengujian</label>
                                        <input type="text" class="form-control form-control-sm" v-model="newData.metode_pengujian" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label">Rencana Ruang Distribusi</label>
                                        <select id="ruang" v-model="newData.ruangid" class="form-select form-control-sm">
                                            <option v-for="ruang in nilaiRuang" :key="ruang.ruangid" :value="ruang.ruangid">
                                                {{ ruang.nama_ruang }}
                                            </option>
                                        </select>
                                    </div>
                        ...
                        <form @submit.prevent="updateData">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label">Target Pengujian</label>
                                        <input type="text" class="form-control form-control-sm" v-model="currentData.target_pengujian" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label">Metode Pengujian</label>
                                        <input type="text" class="form-control form-control-sm" v-model="currentData.metode_pengujian" required>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label">Rencana Ruang Distribusi</label>
                                        <select id="ruang" v-model="currentData.ruangid" class="form-select form-control-sm">
                                            <option v-for="ruang in nilaiRuang" :key="ruang.ruangid" :value="ruang.ruangid">
                                                {{ ruang.nama_ruang }}
                                            </option>
                                        </select>
