        ...
        <div class="row justify-content-center">
            <div class="col-6">
                ...
                <div class="row justify-content-center mb-4">
                    <div class="col-6">
                        <input type="text" class="form-control" v-model="searchQuery" placeholder="Cari Kelompok">
                    </div>
                    <div class="col-auto">
                ...
                <table class="table table-bordered table-striped table-sm" v-if="info.length > 0">
                    ...
                    <tbody>
                        <tr v-for="(a, index) in info" :key="a.idkelompok">
                            <td>{{ index + 1 }}</td>
                            <td>{{ a.kelompok }}</td>
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="tambahData">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label">Kelompok Sample</label>
                                        <input type="text" class="form-control form-control-sm" v-model="newData.kelompok" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                        ...
                        <form @submit.prevent="updateData">
                            <div class="row">
                                <div class="col-12">
                                    <div class="mb-3">
                                        <label class="form-label">Kelompok Sample</label>
                                        <input type="text" class="form-control form-control-sm" v-model="currentData.kelompok" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
