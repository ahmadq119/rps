                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><a href="../labpreparasi/penerimaan/" class="card-link">Penerimaan Sample</a></li>
                                <li><a href="../labpreparasi/persiapan_tempat_kerja/" class="card-link">Persipaan Tempat Kerja</a></li>
                                <li><a href="../labpreparasi/bahan/" class="card-link">Permintaan Bahan</a></li>
                                <li><a href="../labpreparasi/rekaman_rh_temperatur/" class="card-link">Rekaman Ruang Pengujian</a></li>
                                <li><a href="../labpreparasi/report/" class="card-link">Laporan</a></li>
                                <li><a href="../labpreparasi/users/" class="card-link">User</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
