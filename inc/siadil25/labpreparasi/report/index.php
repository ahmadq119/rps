                    ...
                    <form class="row justify-content-center">
                        <div class="col-3">
                            ...
                            <select v-model="newData.laporan" id="laporan" class="form-select">
                                ...
                                <option value="1"><i class="fas fa-virus"></i> Rekap Preparasi Sample</option>
                                <option value="2"><i class="fas fa-print"></i> Rekap Persiapan Tempat Kerja</option>
                                <option value="3"><i class="fas fa-print"></i> Rekaman Ruang Pengujian</option>
                                <option value="4"><i class="fas fa-print"></i> Rekaman UV Ruang Pengujian</option>
                                <option value="5"><i class="fas fa-print"></i> Rekaman Pengelolaan Sampel Pra Pengujian</option>
                            </select>
                        </div>
                        <div class="col-2">
                        ...
                        <div class="col-3">
                            <div class="mb-3">
                                ...
                                <auto-suggest v-model="newData.manajerTeknis" :suggestions="manajerTeknis" display-key="nama_pegawai" extra-key="nip_pegawai" @input="debounce" @select="selectManajerTeknis"></auto-suggest>
                            </div>
                        </div>
                        <div class="col-2">
