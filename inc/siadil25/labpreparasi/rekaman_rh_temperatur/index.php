        ...
        <div class="row justify-content-center">
            <div class="col-10">
                ...
                <div class="text-center mb-4">
                    ...
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addDataModal">Tambah Rekaman Ruang Pengujian</button>
                </div>
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="tambahData">
                            <div class="row">
                                ...
                                <div class="col-4">
                                    <div class="mb-3">
                                        <label class="form-label">Nilai Temperatur</label>
