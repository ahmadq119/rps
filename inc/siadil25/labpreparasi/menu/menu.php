    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $current_page == 'penerimaan/index' ? 'active' : '' ?>" href="../penerimaan/"><i class="fas fa-tag"></i> Penerimaan Sampel</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item <?= $current_page == 'rekaman_uv_ruangan/index' ? 'active' : '' ?>" href="../rekaman_uv_ruangan/">UV Ruang Pengujian</a></li>
                        <li>
