...
<head>
    ...
    <title>SIADIL25 : Pelayanan</title>
    <!-- Menambahkan favicon -->
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><a href="../pelayanan/penerimaan/" class="card-link">Penerimaan Sample Uji</a></li>
                                <li><a href="../pelayanan/penanganan/" class="card-link">Penanganan Sample Uji</a></li>
                                <li><a href="../pelayanan/lhu/" class="card-link">Laporan Hasil Uji (LHU)</a></li>
                                <li><a href="../pelayanan/customer/" class="card-link">Customer</a></li>
                                <li><a href="../pelayanan/jenis_sample/" class="card-link">Jenis Sample</a></li>
                                <li><a href="../pelayanan/report/" class="card-link">Laporan</a></li>
                                <li><a href="../pelayanan/users/" class="card-link">User</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
