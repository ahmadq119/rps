...
<head>
    ...
    <title>SIADIL25 : Admin Laboratorium</title>
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><a href="../adminlab/daftar_sample/" class="card-link">Daftar Sample (Disposisi)</a></li>
                                <li><a href="../adminlab/lhus/" class="card-link">Laporan Hasil Uji Sementara (LHUS)</a></li>
                                <li><a href="../adminlab/organ_target/" class="card-link">Organ Target</a></li>
                                <li><a href="../adminlab/users/" class="card-link">User</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
