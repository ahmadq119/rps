...
<page backtop="45mm" backbottom="10mm" backleft="5mm" backright="5mm">
	...
	<table width="1091" border="1">
		...
		$thn = $_REQUEST['tahun'];
		$i = 0;
		$sql = sqlsrv_query($koneksi, "select * from view_penerimaan_sample where year(tgl_terima)='$thn' and month(tgl_terima)='$bln'");
		...
		?>
			<tbody>
				<tr>
					...
					<td width="80" align="center"><?php echo date_format($r['CreatedAt'], 'H:i:s'); ?></td>
					<td width=" 100"><?php echo $r['kd_sample']; ?></td>
					<td width="200" align="center"><?php echo $r['nama_sample']; ?></td>
					<td width="85" align="center"><?php echo $r['jumlah']; ?> <?php echo $r['satuan']; ?></td>
					<td width="80" align="center"><?php echo $r['kondisi_sample']; ?></td>
					<td width="155" align="center"><?php echo $r['mt']; ?></td>
					<td width="85">&nbsp;</td>
				</tr>
