        ...
        <div class="row justify-content-center">
            <div class="col-10">
                ...
                <div class="text-center mb-4">
                    ...
                    <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addDataModal">Tambah Rekaman UV Alat Pengujian</button>
                </div>
                        ...
                        <form @submit.prevent="tambahData">
                            <div class="row">
                                <div class="col-1" hidden>
                                    <div class="mb-3">
                                        <label for="ruangid" class="form-label">Ruang </label>
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        ...
                                        <!--input type="text" id="nama_alat" class="form-control form-control-sm" v-model="newData.nama_alat" required-->
                                        <auto-suggest v-model="newData.nama_alat" :suggestions="alat" display-key="nama_alat" extra-key="nama_alat" @input="debouncedSearchAlat" @select="selectAlat"></auto-suggest>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3">
                                    <div class="mb-3">
                                        ...
                                        <!--input type="text" id="nama_alat" class="form-control form-control-sm" v-model="currentData.nama_alat" required-->
                                        <auto-suggest v-model="currentData.nama_alat" :suggestions="alat" display-key="nama_alat" extra-key="nama_alat" @input="debouncedSearchAlat" @select="selectAlatNew"></auto-suggest>
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="mb-3">
