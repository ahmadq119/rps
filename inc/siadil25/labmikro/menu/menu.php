    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link <?= $current_page == 'isolasi/index' ? 'active' : '' ?>" href="../isolasi/">Isolasi Awal</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item disabled <?= $current_page == 'persiapan_tempat_kerja/index' ? 'active' : '' ?>" href="../persiapan_tempat_kerja/">Persiapan Tempat Kerja</a></li>
                    </ul>
                </li>
                <li class="nav-item">
