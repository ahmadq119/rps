                    ...
                    <form class="row justify-content-center">
                        <div class="col-3">
                            ...
                            <select v-model="newData.laporan" id="laporan" class="form-select form-select-sm">
                                ...
                                <option value="1"><i class="fas fa-virus"></i> Rekapitulasi Pemeriksaan Mikrobiologi</option>
                                <option value="2" disabled><i class="fas fa-print"></i> Rekap Persiapan Tempat Kerja</option>
