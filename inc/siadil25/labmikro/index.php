                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><a href="../labmikro/isolasi/" class="card-link">Isolasi Awal</a></li>
                                <li><a href="../labmikro/hasil/" class="card-link">Hasil Pengujian</a></li>
                                <li><a href="../labmikro/bahan/" class="card-link">Permintaan Bahan</a></li>
                                <li><a href="../labmikro/rekaman_rh_temperatur/" class="card-link">Rekaman Ruang Pengujian</a></li>
                                <li><a href="../labmikro/rekaman_uv_ruang/" class="card-link">Rekaman UV Ruang Pengujian</a></li>
                                <li><a href="../labmikro/rekaman_uv_alat/" class="card-link">Rekaman UV Alat Pengujian</a></li>
                                <li><a href="../labmikro/report/" class="card-link">Laporan</a></li>
                                <li><a href="../labmikro/users/" class="card-link">User</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
