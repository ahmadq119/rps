...
<page backtop="35mm" backbottom="10mm" backleft="5mm" backright="5mm">
	...
	<table width="1091" border="1">
		...
		$i = 0;
		$sql = sqlsrv_query($koneksi, "SELECT DISTINCT kd_sample, tgl_kegiatan, nama_kegiatan, menghidupkan_uv, alkohol_1, menyiapkan_bahan, menyiapkan_alat, membersihkan_sisa_bahan, alkohol_2, membuang_sisa_bahan, mengembalikan_alat, idpeg, ruangid, keterangan, tgl_terima, nama_pegawai, nama_ruang, nama_sample 
		FROM view_persiapan_tempat_kerja 
		WHERE ruangid = '$ruang' and year(tgl_kegiatan) = '$thn' and month(tgl_kegiatan)= '$bln' 
