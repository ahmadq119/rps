...
<table width=" 200" border="1" align="center">
    ...
    ?>
    <div class="judul">
        <p align="center">REKAPITULASI PEMERIKSAAN PENGUJIAN</p>
    </div>
    <br>
    <table>
        <tr>
    ...
    <table width="1091" border="1">
        <thead>
            <tr>
                ...
                <th width="150" rowspan="2">Metode Pemeriksaan</th>
                <th width="90" rowspan="2">Hasil Pemeriksaan</th>
        ...
        $bln = $_REQUEST['bulan'];
        $i = 0;
        $sql = sqlsrv_query($koneksi, "SELECT * FROM view_penerimaan_sample_labformalin 
        WHERE year(tgl_uji)='$thn' AND month(tgl_uji)='$bln'
        ORDER BY tgl_uji ASC, kd_sample ASC");
        ...
        ?>
            <tbody>
                <tr>
                    ...
                    <td width="150"><?php echo $r['metode_pengujian']; ?></td>
                    <td width="90">
                        <?php echo $r['hasil_pengujian']; ?>
                    </td>

                    <td width="120"> <?php echo $r['nama_pegawai']; ?></td>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                </tr>
