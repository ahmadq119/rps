...
<nav class="navbar navbar-expand-lg warna-nav fixed-top" data-bs-theme="dark">
    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="#"><i class="fas fa-home text-warning"></i> <span class="badge bg-warning"><?php echo strtoupper($_SESSION['folder']); ?></span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 nav justify-content-center">
                <li class="nav-item">
                    <a class="nav-link <?= $current_page == '../index' ? 'active' : '' ?>" aria-current="page" href="../index.php">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?= $current_page == 'bahan/index' ? 'active' : '' ?>" href="../bahan/"><i class="fas fa-flask"></i> Form Permintaan Bahan</a>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item <?= $current_page == 'rekaman_rh_temperatur/index' ? 'active' : '' ?> disabled" href="../rekaman_rh_temperatur/">RH & Temp Ruang Pengujian</a></li>
                        ...
                        <li><a class="dropdown-item <?= $current_page == 'rekaman_verifikasi_suhu_alat/index' ? 'active' : '' ?>" href="../rekaman_verifikasi_suhu_alat/">Rekaman Verifikasi Suhu Alat</a></li>
                    </ul>
                </li>
                <li class="nav-item">
