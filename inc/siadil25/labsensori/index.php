                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul>
                                <li><a href="../labsensori/penerimaan/" class="card-link">Penerimaan Sample</a></li>
                                <li><a href="../labsensori/hasil/" class="card-link">Hasil Pengujian</a></li>
                                <li><a href="../labsensori/bahan/" class="card-link">Permintaan Bahan</a></li>
                                <li><a href="../labsensori/rekaman_rh_temperatur/" class="card-link">Rekaman Ruang Pengujian</a></li>
                                <li><a href="../labsensori/report/" class="card-link">Laporan</a></li>
                                <li><a href="../labsensori/users/" class="card-link">User</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
